...
async function build() {
  ...
  // Pages: home, per-project stories, steal. Folder/index.html gives clean
  // URLs (/work/<slug> and /steal) on any static host.
  ...
  await render("steal.ejs", path.join("steal", "index.html"), { config });
